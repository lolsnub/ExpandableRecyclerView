...
public class Band {
    ...
    public void getBandData(ArrayList<Band> bands){
        ...
        bands.add(new Band("Pastel Palettes", "#5B67FF", "https://firebasestorage.googleapis.com/v0/b/portfolio-f214c.appspot.com/o/Band_logo%2FPastel_Palettes.png?alt=media&token=35655b1b-eaf2-449a-bc9d-9a6410768f65"));
